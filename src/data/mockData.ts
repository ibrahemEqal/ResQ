...
export const MOCK_TIPS = [
  {
    ...
    do: [
      "استخدم أقرب مخرج طوارئ",
      "اتصل بالدفاع المدني فوراً",
      "استخدم الدرج ولا تستخدم المصعد",
    ],
    dont: [
      "لا تحاول إطفاء الحريق إذا كان كبيراً",
      "لا تعد لأخذ مقتنياتك الشخصية",
    ],
  },
  {
    id: "2",
    ...
    do: [
      "تأكد من مجرى التنفس",
      "ارفع قدمي المصاب قليلاً",
      "اتصل بالعيادة الجامعية",
    ],
  ...
  },
  {
    ...
    title: "مشكلة أمنية",
    do: [
      "ابتعد عن مصدر الخطر بهدوء",
      "أبلغ أمن الجامعة فوراً",
      "ابق في مكان آمن ومغلق",
    ],
    dont: [
      "لا تتدخل بنفسك لحل المشكلة",
      "لا تقم بتصوير المعتدين إذا كان ذلك يعرضك للخطر",
    ],
  },
];
  ...
  recent: [
    {
      id: "101",
      type: "Fire",
      location: "مبنى الهندسة - الطابق الثاني",
      status: "Critical",
      time: "10 mins ago",
    },
    {
...
export const createMockReport = async (
