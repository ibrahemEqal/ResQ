        ...
        <SafeAreaView style={styles.safeArea}>
            <View style={styles.container}>
                ...
                <View style={styles.grid}>
                    {/* Card 1: Tips */}
                    <TouchableOpacity style={styles.premiumCard} onPress={() => router.push('/tips')} activeOpacity={0.8}>
                    ...
                    {/* Card 2: Dashboard */}
                    <TouchableOpacity style={styles.premiumCard} onPress={() => router.push('/dashboard')} activeOpacity={0.8}>
                        <View style={styles.cardHeader}>
...
const styles = StyleSheet.create({
    ...
    container: {
        flex: 1, padding: 24, width: '100%', maxWidth: 450, alignSelf: 'center',
    },
    ...
    greeting: { fontSize: 14, color: COLORS.textSecondary, fontWeight: '600', marginBottom: 2 },
    ...
    locationBadge: {
        ...
        paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12, marginTop: 8, alignSelf: 'flex-start'
    },
    locationText: { fontSize: 12, color: COLORS.secondary, fontWeight: '700', marginLeft: 4 },
    profileAvatar: {
    ...
    /* SOS Button Styles */
    sosContainer: { alignItems: 'center', justifyContent: 'center', marginBottom: 50, position: 'relative', height: 220 },
    sosPulseCircle: {
    ...
    sosButton: {
        ...
        justifyContent: 'center', alignItems: 'center',
        shadowColor: '#FF3B30', shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.5, shadowRadius: 20, elevation: 15,
        borderWidth: 4, borderColor: 'rgba(255,255,255,0.3)',
    },
    sosText: { color: COLORS.surface, fontSize: 32, fontWeight: '900', marginTop: 4, letterSpacing: 3 },
    sosInstruction: { position: 'absolute', bottom: -15, fontSize: 14, color: COLORS.textSecondary, fontWeight: '600' },
    ...
    premiumCard: {
        ...
        shadowColor: '#1D3557', shadowOffset: { width: 0, height: 8 },
    ...
    notificationDot: {
        ...
        position: 'absolute', top: 0, right: 0, borderWidth: 2, borderColor: COLORS.surface
    },
